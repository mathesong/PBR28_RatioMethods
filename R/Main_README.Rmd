---
title: "Assessment of simplified ratio-based approaches for quantification of PET [11C]PBR28 data: Data and analysis code"
output:   
    md_document:
    variant: markdown_github
---

This is the repository containing the data and full analysis code used for our [publication](https://ejnmmires.springeropen.com/articles/10.1186/s13550-017-0304-1):

> Matheson GJ, Plavén-Sigray P, Forsberg A, Varrone A, Farde L, Cervenka S. Assessment of simplified ratio-based approaches for quantification of PET \[^11^C]PBR28 data. EJNMMI research. 2017 Dec 1;7(1):58.

The analysis begins after time activity curves have been extracted from the dynamic PET images, as this is a reanalysis of a data set which was [previously published on](https://link.springer.com/article/10.1007%2Fs00259-015-3149-8).  The data is supplied in the RawData folder, and the analysis notebook is provided in the R folder.

## Software Requirements

### Programs

The analysis is performed using R.  For those who have not used R before, you should start by downloading [R](https://www.r-project.org/), and then [RStudio](https://www.r-project.org/).  If you wish to compile the report as a pdf, you will also need [MiKTeX](https://miktex.org/).  
...
Several packages and/or versions of packages used in the analysis are not available from CRAN and are instead hosted on GitHub.  These can be installed directly using the _devtools_ package using the following syntax:
...
At this point, you will have downloaded the repository to your computer.  If you have not used Git before, I recommend that you follow [this short tutorial](https://try.github.io/levels/1/challenges/1) to get you started.
